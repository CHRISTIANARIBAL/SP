...
#     password = models.CharField(max_length=128)  # (You should hash passwords in real cases)
...
#     customer = models.ForeignKey('Customer', on_delete=models.CASCADE, null=True, blank=True)  # 🔥 NEW LINE
